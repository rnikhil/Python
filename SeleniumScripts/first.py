...
driver = webdriver.Chrome("C:\Python34\Scripts\chromedriver.exe")  # creates webdriver object to call web driver
                                                                   # It is used to start Chrome Browser
...
driver.get_screenshot_as_file("C:\\Python34\\screenshots\\facebook.png")
driver.find_element_by_id("email").send_keys("mnikhil.25")
driver.find_element_by_id("pass").send_keys("nikhil25")
